...
class VisualGedcomIds:
    ...
    def __init__(self, svc_config=None) -> None:
        ...
        id_attributes = [  # ID name: (type, config/state attribute, action)
            ...
            ("RBLocationGrouping", ("RadioButton", "RBLocationGrouping", "Redraw")),
            ("CBUseSoundexLocationGrouping", ("CheckBox", "UseSoundexLocationGrouping", "Redraw")),
            ("CBLabelNames", ("CheckBox", "LabelNames", "Redraw")),
            ("INTMaxMigrationLines", ("SpinCtrl", "MaxMigrationLines", "Reload")),
            ("CBExcludeUnknownMigrationCountries", ("CheckBox", "ExcludeUnknownMigrationCountries", "Redraw")),

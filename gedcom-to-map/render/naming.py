__all__ = ["NameProcessor", "isValidName", "compareNames", "simplifyLastName", "soundex"]
"""
naming.py
...
def simplifyLastName(lastName):
    ...
    """
    # TODO remove bracketed part "LastName (Born LastName)"

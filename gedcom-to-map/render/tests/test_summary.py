...
class DummyLocation:
    def __init__(self, lat=0, lon=0, country_name="Country", continent="Continent", alt_addr="Alt", canonical_addr=None):
...
def test_write_people_summary(tmp_path):
    people = {
        "I1": DummyPerson("Alice", DummyEvent("Place1", DummyLocation(), None), DummyEvent("Place2", DummyLocation(), None)),
        "I2": DummyPerson("Bob")
    }
...
def test_write_birth_death_countries_summary(tmp_path):
    people = {
        "I1": DummyPerson("Alice", DummyEvent("Place1", DummyLocation(country_name="A", continent="X"), None), DummyEvent("Place2", DummyLocation(country_name="B", continent="Y"), None)),
        "I2": DummyPerson("Bob")
    }

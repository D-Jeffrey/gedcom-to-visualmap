...
def safe_read_text(path: Union[str, Path], encoding: str = DEFAULT_ENCODING,
...
def safe_write_text(path: Union[str, Path], content: str,
...
@contextmanager
def safe_temp_file(mode: str = 'w+', suffix: str = '',
                   encoding: str = DEFAULT_ENCODING,
                   newline: Optional[str] = None,
                   delete: bool = True):
    """
...
def ensure_utf8_csv(path: Union[str, Path], mode: str = 'r',
                    newline: str = '', **kwargs):
    """

...
class TestGetOptionSections:
    ...
    def test_valid_sections(self):
        options = {
            "Core": {"option1": {"type": "str", "default": "value1"}, "option2": {"type": "int", "default": 42}},
            "HTML": {"option3": {"type": "bool", "default": True}},
    ...
    def test_mixed_content(self):
        options = {"ValidSection": {"key": {"type": "str", "default": "val"}}, "InvalidSection": {"key": "not_a_dict"}}
        result = config_io.get_option_sections(options)
...
class TestSetOptions:
    ...
    def test_set_multiple_options(self):
        obj = Mock()
        options_types = {"str_opt": "str", "int_opt": "int", "bool_opt": "bool"}
        options_defaults = {"str_opt": "hello", "int_opt": "42", "bool_opt": "true"}
...
class TestSetMarkerDefaults:
    ...
    def test_set_marker_defaults(self):
        obj = Mock()
        obj.options = {"html_display_options": {"marker1": {"default": "value1"}, "marker2": {"default": "value2"}}}
...
class TestSetMarkerOptions:
    ...
    def test_set_valid_markers(self):
        obj = Mock()
        obj.options = {"html_display_options": {"marker1": {}, "marker2": {}}}
...
class TestBuildSectionKeys:
    ...
    def test_build_section_keys(self):
        options = {
            ...
            "HTML": {"option3": {"type": "bool", "default": True, "ini_section": "HTML"}},
        }
    ...
    def test_ini_type_override(self):
        options = {"Core": {"option1": {"type": "str", "default": "val", "ini_section": "Core", "ini_type": "int"}}}
...
class TestLoadSection:
    ...
    def test_load_section_basic(self):
        obj = Mock()
        obj.gvConfig = {"TestSection": {"key1": "42", "key2": "true"}}
...
class TestLoadSettings:
    ...
    def test_load_settings_integration(self):
        ...
        try:
            ...
            obj.options = {"Core": {"InputFile": {"type": "str", "default": "", "ini_section": "Core"}}}
            obj.ResultType = Mock()
    ...
    def test_load_settings_migration(self):
        ...
        try:
            obj = Mock()
            obj.settingsfile = temp_file
            obj.options = {"old_ini_settings": {"OldSetting": "Core"}}
            obj.ResultType = Mock()
            obj.file_open_commands = Mock()
            obj.file_open_commands.list_file_types.return_value = []
            obj.setInput = Mock()
...
class TestSaveSettings:
    ...
    def test_save_settings_basic(self):
        ...
        try:
            ...
            obj.options = {
                "Core": {"TestKey": {"type": "str", "default": "val", "ini_section": "Core"}},
                "HTML": {},
                "Summary": {},
                "KML": {},
            }
...
class TestIntegration:
    ...
    def test_load_save_roundtrip(self):
        ...
        try:
            ...
            obj.settingsfile = temp_file
            obj.gvConfig = None
            obj.options = {"Core": {"TestOption": {"type": "str", "default": "default_val", "ini_section": "Core"}}}

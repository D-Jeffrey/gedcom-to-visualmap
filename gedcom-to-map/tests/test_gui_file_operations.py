...
class TestOpenInBrowser:
    ...
    @patch("gui.actions.file_operations.subprocess.Popen")
    @patch("gui.actions.file_operations.shutil.which", return_value="/usr/bin/firefox")
...
class TestOpenWithDefaultHandler:
    ...
    @patch("gui.actions.file_operations.platform.system", return_value="Windows")
    ...
    @patch("gui.actions.file_operations.platform.system", return_value="FreeBSD")
    @patch.object(FileOpener, "_open_with_platform_default")
...
class TestOpenWithStartfile:
    ...
    @patch("gui.actions.file_operations.os.startfile")
...
class TestOpenWithPlatformDefault:
    ...
    @patch("gui.actions.file_operations.sys.platform", "darwin")
    @patch("gui.actions.file_operations.subprocess.Popen")
    ...
    @patch("gui.actions.file_operations.sys.platform", "linux")
    @patch("gui.actions.file_operations.subprocess.Popen")
    @patch("gui.actions.file_operations.shutil.which", return_value="/usr/bin/xdg-open")
    ...
    @patch("gui.actions.file_operations.sys.platform", "win32")
    @patch("gui.actions.file_operations.os.startfile")
...
class TestOpenWithCustomCommand:
    ...
    @patch("gui.actions.file_operations.subprocess.Popen")
    @patch("gui.actions.file_operations.shutil.which", return_value="/usr/bin/code")
    ...
    @patch("gui.actions.file_operations.sys.platform", "darwin")
    @patch("gui.actions.file_operations.shutil.which", return_value=None)
    @patch("gui.actions.file_operations.os.path.isabs", return_value=False)
    ...
    @patch("gui.actions.file_operations.subprocess.Popen", side_effect=FileNotFoundError())
    @patch("gui.actions.file_operations.sys.platform", "darwin")
    ...
    @patch("gui.actions.file_operations.subprocess.Popen")
    @patch("gui.actions.file_operations.shutil.which", return_value="/usr/bin/myapp")
